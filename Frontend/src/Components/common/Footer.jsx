...
const Footer = () => (
  <footer className="w-full bg-gradient-to-r from-blue-50 via-purple-50 to-indigo-100 border-t border-gray-200 py-6 mt-8">
    ...
    <style>{`
      ...
      .socialContainer:active { transform: scale(0.9); transition-duration: .3s; }
