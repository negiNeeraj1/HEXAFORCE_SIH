	...
	return (
		<nav
			className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
				isScrolled
					? 'bg-[#e6fcf5] shadow-lg border-b border-gray-300'
					: 'bg-[#e6fcf5] shadow-md'
			}`}
		>
				...
				<div className="flex items-center justify-between h-16">
					...
					<div className="flex items-center space-x-4">
						...
						{user ? (
							<div className="relative">
								<button
									...
									className="flex items-center space-x-3 bg-white/80 backdrop-blur-sm rounded-full pr-4 pl-2 py-2 shadow-md hover:shadow-lg hover:bg-white/80 transition-all duration-300 group"
								>
								...
								{/* User Dropdown */}
								{isUserMenuOpen && (
									<div className="absolute right-0 mt-2 w-48 bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-gray-300 py-2 animate-fade-in">
										...
										<button
											...
											className="w-full flex items-center space-x-2 px-4 py-2 text-left text-red-600 hover:bg-red-100 hover:text-red-800 transition-colors duration-200"
										>
						...
						<button
							...
							className="md:hidden p-2 rounded-lg bg-white/80 backdrop-blur-sm shadow-md hover:shadow-lg transition-all duration-300"
						>
							{isMobileMenuOpen ? (
			...
			{isMobileMenuOpen && user && (
				<div className="md:hidden bg-[#e6fcf5] backdrop-blur-lg border-t border-gray-200 shadow-lg">
